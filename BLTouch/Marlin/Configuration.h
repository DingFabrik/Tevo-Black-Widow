/**
 * Marlin 3D Printer Firmware RC7
...
#define STRING_CONFIG_H_AUTHOR "(ANTCLABS, default config with BLTouch)" // Who made the changes.
...
//
#define SHOW_CUSTOM_BOOTSCREEN      //****************** TEVO (10X64 Byte) & BLTouch (6X64 Byte) ***********************
// @section machine
...
#define TEMP_SENSOR_0 11      //********** Black Widow **********
#define TEMP_SENSOR_1 0
#define TEMP_SENSOR_2 0
#define TEMP_SENSOR_3 0
#define TEMP_SENSOR_BED 11    //********** Black Widow **********
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // My 3D Printer
  #define  DEFAULT_Kp 39.38
  #define  DEFAULT_Ki 3.51
  #define  DEFAULT_Kd 110.34
...
//
//#define Z_MIN_PROBE_ENDSTOP                 //***** BLTouch ***** 변경하지 않음(기본값)

// Enable Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN to use the Z_MIN_PIN for your Z_MIN_PROBE.
// The Z_MIN_PIN will then be used for both Z-homing and probing.
#define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN    //***** BLTouch ***** 변경하지 않음(기본값)
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 345   //380 //***** Black Widow ***** 
#define Y_MAX_POS 240   //250 //***** Black Widow ***** 
#define Z_MAX_POS 250         //***** Black Widow ***** 
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {160,160,3200,935}  // default steps per unit for Ultimaker
...
#define EEPROM_SETTINGS   //***** Black Widow ***** 
...
// Preheat Constants
#define PREHEAT_1_TEMP_HOTEND 190 //180  //***** Black Widow ***** 
...
#define PRINTCOUNTER  //***** Black Widow ***** 
...
#define DOGLCD      // Full graphics display  //***** Black Widow ***** 
...
//
#define ENCODER_PULSES_PER_STEP 3   //***** Black Widow ***** 

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1 //***** Black Widow ***** 
...
//
#define REVERSE_ENCODER_DIRECTION   //***** Black Widow ***** 
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU   //***** Black Widow ***** 
...
//
#define REPRAP_DISCOUNT_FULL_GRAPHIC_SMART_CONTROLLER   //***** Black Widow ***** 
